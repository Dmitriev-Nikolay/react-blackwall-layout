...
import mainBgSmall from '../assets/img/main-bg-small.png';
            ...
            <div className="container">
                <section className="start-block">
                    <div className="start-block__inner">
                        ...
                        <button className="start-block__btn button">Start for free</button>
                    </div>
                    <div className="start-block__img-container">
                        <img src={ mainBgSmall } alt="Main" width="550" height="500" />
                    </div>
                </section>
                <section className="info-block">
                    ...
                    <div className="info-block__stats">
                        ...
                        <div className="info-block__rating">
                            <div className="value-stats">4.9</div>
                            <div className="grade-icons">
                ...
                <section className="company-block">
                    <img className="logo" src={ airbnbLogo } alt="Airbnb logo" width="112" height="35" />
                    <img className="logo" src={ hubspotLogo } alt="Hubspot logo" width="105" height="30" />
                    <img className="logo" src={ googleLogo } alt="Google logo" width="105" height="35" />
                    <img className="logo" src={ microsoftLogo } alt="Microsoft logo" width="152" height="32" />
                    <img className="logo" src={ walmartLogo } alt="Walmart logo" width="138" height="32" />
                    <img className="logo" src={ fedExLogo } alt="FedEx logo" width="100" height="30" />
                </section>
                <section className="features-block">
                    ...
                    <div className="features-block__list">
                        <div className="list-item">
                            <img className="item-icon" src={ sale } alt="Sale" width="72" height="72" />
                        ...
                        <div className="list-item">
                            <img className="item-icon" src={ medal } alt="Medal" width="56" height="72" />
                        ...
                        <div className="list-item">
                            <img className="item-icon" src={ check } alt="Check" width="72" height="72" />
